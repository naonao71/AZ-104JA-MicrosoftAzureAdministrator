...
1. [**az104-06-vnet01** 仮想ネットワーク] ブレードの [**設定**] セクションで、[**サブネット**] をクリックし、[**+ 追加**] をクリックします。
...
1. [**次へ:**] をクリックする**[バックエンド] >**、**[アプリケーション ゲートウェイの作成]** ブレードの **[バックエンド]** タブで、 **[+ バックエンド プールの追加]** をクリックし、**[バックエンド プールの追加]** ブレードで、次の設定を指定します (その他は既定値のままにします)。        

    | 設定 | 値 |
    | --- | --- |
    | 名前 | **az104-06-appgw5-be1** |
    | ターゲットを使用せずにバックエンド プールを追加する | **No** |
    | ターゲット タイプ | **IP アドレスまたはホスト名** |
    | ターゲット | **10.62.0.4** |
    | ターゲット タイプ | **IP アドレスまたはホスト名** |
    | ターゲット | **10.63.0.4** |
...
1. [**追加**] をクリックし、[**次へ**] をクリックします。**構成 >**] をクリックし、[**アプリケーション ゲートウェイの作成**] ブレードの [**構成**] タブで、[**+ ルールの追加**] をクリックします。 
