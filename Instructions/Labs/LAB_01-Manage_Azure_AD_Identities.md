...
1. **「管理」** セクションで、**「割り当てられたロール」** をクリックし、**「+ 割り当ての追加」** ボタンをクリックして、**ロールの選択** ドロップダウンリストから **ユーザー管理者** の役割を選択して、**「次へ」** をクリックします。

1. **割り当ての種類** で **「アクティブ」** を選択し、**「理由の入力」** 欄に **az-104 lab** と入力して、**「割り当て」** をクリックします。
