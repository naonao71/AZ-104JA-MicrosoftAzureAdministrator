...
1. 新しく作成した Azure AD テナントのブレードを表示するには、**テナントが正常に作成されました。新しいテナント Contoso Lab に移動するには、ここをクリックします。** リンクまたは **ディレクトリ + サブスクリプション** ボタン (「Cloud Shell」ボタンの右側) をクリックします。
...
1. 「**+ メンバーシップの追加**」 をクリックし、ゲスト ユーザー アカウントを **IT ラボ管理者グループ** に追加します。
...
1. 「**Azure Active Directory Premium P2 - ライセンスされているユーザー**」 ブレードで、このラボでライセンス割り当て済みのユーザー アカウントを選択し、「**ライセンスの削除**」 をクリックします。確認画面が表示されたら、「**はい**」 をクリックします。
