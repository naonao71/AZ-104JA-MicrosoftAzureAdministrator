...
1. 「Cloud Shell」 ウィンドウで、次のコマンドを実行して最初のバーチャル ネットワークを作成し、アップロードしたテンプレートとパラメーター ファイルを使用して仮想マシンをデプロイします。
...
1. 次の設定でピアリングを追加します (他のユーザーには既定値を残します)。
    ...
    | 設定 | 値|
    | --- | --- |
    | az104-05-vnet0 からリモートバーチャル ネットワークへのピアリングの名前 | **az104-05-vnet0_to_az104-05-vnet1** |
    | バーチャル ネットワーク デプロイ モデル | **Resource Manager** |
    | サブスクリプション | このラボで使用する Azure サブスクリプションの名前 |
    | バーチャル ネットワーク | **az104-05-vnet1 (az104-05-rg1)** |
    | az104-05-vnet1 から az104-05-vnet0 へのピアリングの名前 | **az104-05-vnet1_to_az104-05-vnet0** |
    | az104-05-vnet0 から az104-05-vnet1 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
    | az104-05-vnet1 から az104-05-vnet0 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
...
1. 次の設定でピアリングを追加します (他のユーザーには既定値を残します)。
    ...
    | 設定 | 値|
    | --- | --- |
    | az104-05-vnet0 からリモートバーチャル ネットワークへのピアリングの名前 | **az104-05-vnet0_to_az104-05-vnet2** |
    | バーチャル ネットワーク デプロイ モデル | **Resource Manager** |
    | サブスクリプション | このラボで使用する Azure サブスクリプションの名前 |
    | バーチャル ネットワーク | **az104-05-vnet2 (az104-05-rg2)** |
    | az104-05-vnet2 から az104-05-vnet0 へのピアリングの名前 | **az104-05-vnet2_to_az104-05-vnet0** |
    | az104-05-vnet0 から az104-05-vnet2 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
    | az104-05-vnet2 から az104-05-vnet0 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
    | az104-05-vnet2 から az104-05-vnet0 への転送トラフィックを許可する | **Disabled** |
    | az104-05-vnet0 から az104-05-vnet2 への転送トラフィックを許可する | **Disabled** |
    | ゲートウェイ通過を許可する | **(チェックボックスをオフにする)** |

    > **注**: この手順では、az104-05-vnet0 から az104-05-vnet2、az104-05-vnet2 から az104-05-vnet0 までの 2 つのグローバル ピアリングを確立します。
...
1. 次の設定でピアリングを追加します (他のユーザーには既定値を残します)。
    ...
    | 設定 | 値|
    | --- | --- |
    | az104-05-vnet1 からリモートバーチャル ネットワークへのピアリングの名前 | **az104-05-vnet1_to_az104-05-vnet2** |
    | バーチャル ネットワーク デプロイ モデル | **Resource Manager** |
    | サブスクリプション | このラボで使用する Azure サブスクリプションの名前 |
    | バーチャル ネットワーク | **az104-05-vnet2 (az104-05-rg2)** |
    | az104-05-vnet2 から az104-05-vnet1 へのピアリングの名前 | **az104-05-vnet2_to_az104-05-vnet1** |
    | az104-05-vnet1 から az104-05-vnet2 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
    | az104-05-vnet2 から az104-05-vnet1 へのバーチャル ネットワーク アクセスを許可する | **Enabled** |
...
1. プロンプトが表示されたら、**Student**のユーザー名とパスワード **Pa55w.rd1234** を使用してサインインします。
