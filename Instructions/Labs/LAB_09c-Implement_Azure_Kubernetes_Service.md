...
1. 「**Next: Scale >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**スケール**」 タブで 、次の設定を指定します (その他の設定は既定値のままにします)。
...
1. 「**Next: Monitoring >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**監視**」 タブで、「**コンテナーの監視を有効にする**」 を 「**いいえ**」 に設定し、「**確認 + 作成**」 をクリックして、「**作成**」 をクリックします。 
