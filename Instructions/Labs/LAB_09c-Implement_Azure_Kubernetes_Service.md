...
1. Azure portalで「**Kubernetes サービス**」を検索してから、「**Kubernetes サービス**」 ブレードで 「**+ 追加**」、「**+ Kubernetes クラスターの追加**」 をクリックします。 
...
1. 「**次: ノード プール >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**ノード プール**」 タブで 、次の設定を指定します (その他の設定は既定値のままにします)。
...
1. 「**次: 認証 >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**認証**」 タブで、次の設定を指定します (その他は既定値のままにします)。
...
1. 「**次: ネットワーク >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**ネットワーク**」 タブで次の設定を指定します (その他の設定は既定値のままにします)。
    ...
    | ロード バランサー | **Standard** |
    | HTTP アプリケーション ルーティングの有効化 | **(チェックしない)** |


1. 「**次: 統合 >**」 をクリックし、「**Kubernetes クラスターの作成**」 ブレードの 「**統合**」 タブで、「**コンテナーの監視**」 を 「**無効**」 に設定し、「**確認および作成**」 をクリックして、「**作成**」 をクリックします。 
