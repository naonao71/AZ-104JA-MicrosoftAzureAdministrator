...
1. 「**次:ネットワーク >**」 をクリックし、「**ストレージ アカウントの作成**」 ブレードの 「**ネットワーク**」 タブで、利用可能なオプションを確認し、既定のオプション 「**パブリック エンドポイント (すべてのネットワーク)**」 を指定して 、「**次:データ保護 >**」 をクリックします。続いて、「**次:詳細 >**」 をクリックします。
