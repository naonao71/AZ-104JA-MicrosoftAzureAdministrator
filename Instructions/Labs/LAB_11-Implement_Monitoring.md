...
1. [**az104-11-vm0**] ブレードの [**モニタリング**] セクションで、[**ログ**] をクリックします。 
...
1. ツール バーの [**サンプル クエリ**] をクリックし、[**サンプル クエリの開始** ] ペインで各タブを確認し、[**使用可能なメモリ**] を見つけて[**実行**] をクリックします。
...
1. ツール バーの [**サンプル クエリ**] をクリックし、[**サンプル クエリの開始**] ペインで各タブを確認し、[**仮想マシンの空きディスク領域**] を見つけて [**実行**] をクリック します。
