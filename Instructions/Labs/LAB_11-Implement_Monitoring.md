...
1. 「**メトリクス**」 ドロップダウン リストで、「**集計**」 ドロップダウン リストで 「**\Memory\Available Bytes**」 を選択し、「**平均**」 を選択して、結果のグラフを確認します。 
...
1. 「 **アラート ルールの作成** 」 ブレードの 「**アクション グループ (オプション)**」 セクションで、「**アクション グループの選択**」 をクリックし、**＋アクション グループの作成** をクリックします。     
...
1. 「**アラート ルールの作成**」 ブレードに戻り、次の設定を指定します (既定値を他のユーザーのままにします)。
